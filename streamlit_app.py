...
with st.sidebar:
    ...
    q_solar = st.number_input("Radiación solar q_solar (W/m²)", value=1000.0, min_value=100.0, max_value=1500.0, step=50.0)
...
# Valores reportados en el paper (Figura 3)
paper_values = {
    'T_e': 150,
    'T_w': 100,
    'T_s': 133,
...
verification_data = {
    ...
    'Paper': ['~150°C', '100°C', '~133°C', '~30-40%', '~11 g/h'],
...
if all_ok:
    st.success("✅ Todas las variables coinciden con el paper. El modelo es válido.")
else:
    st.warning("⚠️ Algunas variables se desvían del paper. Revisar parámetros.")
...
grid on;
legend('T_e (Emisor)', 'T_w (Agua)', '100°C');
